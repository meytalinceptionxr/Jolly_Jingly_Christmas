...
Shader "Custom/TintTexOpacity2s"
{
	Properties
	{
	...
	SubShader
	{
		...
		{
			float3 switchResult134 = (((i.ASEVFace>0)?(half3(0,0,1)):(half3(0,0,-1))));
			o.Normal = switchResult134;
...
Node;AmplifyShaderEditor.Vector3Node;135;2764.204,-384.1654;Half;False;Constant;_Vector0;Vector 0;8;0;Create;True;0;0;False;0;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;136;2786.204,-216.1654;Half;False;Constant;_Vector1;Vector 1;8;0;Create;True;0;0;False;0;0,0,-1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=32088EB6D9566C0D9687FB7A271A410C76CA2EED